...
private:
    ...
    void handleDynamicExplosionCollision(GravitationalBody &macroBody1, GravitationalBody &macroBody2, GameState &gameState); // Handles 'explosive' collisions that shatter the pieces if the collision satisfies Engine-Constant-defined constraints
